...
// Look for token simplifications
/* void simplify(stack_ptr stack)
{
    token_ptr declare[] = {
...
// TODO: Recode string buffer
bool parse_character(stack_ptr stack, string_ptr *buffer, int *scanner_state, char c)
{
